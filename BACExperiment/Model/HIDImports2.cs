...
/*
This class is originally created by Brian Peek for MSDN's Coding4Fun ,
HOWEVER because of the fact that the HIDImports class in the Wiimotelib.dll is set to private ,
there was no way for me to acces the Library from the class . As a alternative , I made a exact copy of the class
and added it to the WiimoteLib but this time beeing set to public . This way , I was able to call the HID methods from the class
*/
